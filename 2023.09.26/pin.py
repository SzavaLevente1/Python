...
# Kérjük be a felhasználótól a PIN kódot. Maximum 3 próbálkozása lehet. 
#Ha nem találja el, akkor írjuk ki, hogy HIBÁS, és hogy hány próbálkozása maradt még. Három sikertelen próbálkozás után írjuk ki hogy "ZÁROLÁS", egyébként "Sikeres azonosítás".
...
#v1:
#nem lehet az első számjegy 0
#pin=randint(1000,9999) itt a pin int típusú
#ha 1000-nél kisebb számot generálnánk, akkor nem lenne 4 jegyű a pin!!

# #v2:
# pin='' #a pin string típusú
# for i in range(4):
#     szamjegy=randint(0,9)
#     pin+=str(szamjegy) #string típusuvá konvertálja a számjegyet, majd hozzáfűzi a pin-hez
...
jo_pin=pin.rjust(4,'0') # balról tölti fel a stringet megadot hosszra, megadott karakterrel
#ljust jobbról tölti fel a stringet megadot hosszra, megadott karakterrel
# print(jo_pin)
...
while jo_pin!=megadott_pin and probalkozasok_szama>0:
    ...
    if  megadott_pin==mesterkod:
        ...
        if uj_pin==uj_pin2:
             jo_pin=uj_pin
             print('PIN kódját sikeresen megváltozatatta.')
             probalkozasok_szama=3
        else:
             print('A megadott két PIN nem egyezik meg. Pin kódja nem változott!')     
    elif jo_pin!=megadott_pin:
         print(f'Hibas PIN kód. Hátralévő probákozások száma: {probalkozasok_szama}')
